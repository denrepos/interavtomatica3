<footer class="container-fluid">
    <div class="footer">
        ...
        <div class="footer-block-4">
            <div class="footer-block-wrap">
                ...
                <div class="pay-systems icon-pay-system"></div>
    ...
    <div class="copyright col-xs-20">
        <span>Все права защищены </span>
        <span> © Copyright 2005-2015 INTER AUTOMATIC </span>
        <br class="display-none">
        <span>Производство и продажа компонентов</span>
        <span> промышленной автоматики</span>
    </div>
</footer>